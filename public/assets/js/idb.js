...
// Event will trigger on db version change
...
request.onsuccess = function(event) {
    // when db is successfully createed with its object store (from onupgradedneeded event above) or simply established a connection, save reference to db in gloval variable
...
function uploadPizza() {
    ...
    // Upon a successful .getAll() execution, this runs
